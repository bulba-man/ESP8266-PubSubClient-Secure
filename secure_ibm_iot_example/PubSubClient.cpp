...
Serial.println((long)buffer);
Serial.println("for write buffer");
for(int i=0;i<length;i++){
Serial.write(buffer[i]);
}
Serial.println();
Serial.println("-----------------------");
Serial.println("for print buffer");
for(int i=0;i<length;i++){
Serial.print(buffer[i]);
}
Serial.println("=================");
...
Serial.print("buffer[4]");Serial.println(buffer[4]);
Serial.print("buffer[5]");Serial.println(buffer[5]);
